# The Symfony dev instructions kit for Ubuntu
...
The purpose of this repository is to provide instructions to configure a Symfony development environment on **Ubuntu 18.04**.
